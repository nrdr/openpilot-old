...
class LateralPlanner:
  def __init__(self, CP, use_lanelines=True, wide_camera=False):
    self.use_lanelines = use_lanelines if Params().get_bool('Laneful') else False
  ...
  def publish(self, sm, pm):
    ...
    lateralPlan.useLaneLines = self.use_lanelines if Params().get_bool('Laneful') else False
