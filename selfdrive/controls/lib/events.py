...
class NoEntryAlert(Alert):
  def __init__(self, alert_text_2: str,
               alert_text_1: str = "Openpilot Temporarily Suspended",
...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "The best driver assistance system ever.", alert_status=AlertStatus.userPrompt):
    super().__init__(alert_text_1, alert_text_2,
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.steerSaturated: {
    ET.WARNING: Alert(
      ...
      "Driver needs to assist in steering.",
      AlertStatus.userPrompt, AlertSize.mid,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, 1.),
  },
